...
```javascript
nanvarianceyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanvarianceyc@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-strided-nanvarianceyc/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-nanvarianceyc/actions/workflows/test.yml?query=branch:v0.1.1
